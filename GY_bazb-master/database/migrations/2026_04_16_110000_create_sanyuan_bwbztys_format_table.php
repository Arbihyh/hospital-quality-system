...
class CreateSanyuanBwbztysFormatTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create('bllb329_bwbztys', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->text('MQZD')->nullable()->comment('目前诊断');
    ...
    {
        Schema::dropIfExists('bllb329_bwbztys');
    }
}
