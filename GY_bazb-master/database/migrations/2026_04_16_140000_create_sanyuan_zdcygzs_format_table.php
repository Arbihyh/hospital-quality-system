...
class CreateSanyuanZdcygzsFormatTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if (Schema::hasTable('bllb34_zdcygzs')) {
            return;
        }

        Schema::create('bllb34_zdcygzs', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('bllb34_zdcygzs');
    }
}
