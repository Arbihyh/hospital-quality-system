...
class CreateSanyuanYbwffgzsFormatTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if (Schema::hasTable('bllb34_ybwffgzs')) {
            return;
        }

        Schema::create('bllb34_ybwffgzs', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->longText('XMJSON')->nullable()->comment('项目行数据');
    ...
    {
        Schema::dropIfExists('bllb34_ybwffgzs');
    }
}
