...
class CreateSanyuanSjgzsFormatTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if (Schema::hasTable('bllb34_sjgzs')) {
            return;
        }

        Schema::create('bllb34_sjgzs', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('bllb34_sjgzs');
    }
}
