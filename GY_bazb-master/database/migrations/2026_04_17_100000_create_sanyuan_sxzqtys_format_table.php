...
class CreateSanyuanSxzqtysFormatTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if (Schema::hasTable('bllb329_sxzqtys')) {
            return;
        }

        Schema::create('bllb329_sxzqtys', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->text('MQZD')->nullable()->comment('临床诊断');
    ...
    {
        Schema::dropIfExists('bllb329_sxzqtys');
    }
}
