...
class CreateSanyuanZrltysFormatTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if (Schema::hasTable('bllb329_zrltys')) {
            return;
        }

        Schema::create('bllb329_zrltys', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->text('XMMC')->nullable()->comment('拟用耗材名称');
            $table->text('TDFA')->nullable()->comment('替代耗材名称');
    ...
    {
        Schema::dropIfExists('bllb329_zrltys');
    }
}
