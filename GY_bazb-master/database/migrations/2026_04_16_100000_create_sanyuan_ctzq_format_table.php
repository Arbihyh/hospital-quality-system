...
class CreateSanyuanCtzqFormatTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if (Schema::hasTable('bllb329_ctzq')) {
            return;
        }

        Schema::create('bllb329_ctzq', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('bllb329_ctzq');
    }
}
