...
class PatientInfoTarget extends Command
{
     ...
     */
    protected $signature = 'es:patient_info_target {type?}';
        ...
        while (true) {
            ...
            foreach ($res as $item) {
                ...
                $es_params['body'][] = ['doc' => [
                    ...
                    "score" => $item['score'],
                    "pacs_content" => $item['pacs_content'],
                ], 'doc_as_upsert' => true];
            }
