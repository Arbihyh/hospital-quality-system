...
class QueueYaoMin extends Command
{
    /**
     ...
     */
    protected $signature = 'queue:yaomin';
     ...
     * @var string
     */
    protected $description = 'Command 药敏的消息队列消费脚本';
    ...
    public function handle()
    {
        ...
        while (true) {
            ...
            $data = QueueList::query()->where(["type" => "yaomin", "status" => 0])->orderBy("id", "desc")->first();
            if (!$data) {
                sleep(10);
                continue;
            }
            ...
            try{
                ...
                $homeDataService->getYaoMinData($data["data"]);
                // 删除
