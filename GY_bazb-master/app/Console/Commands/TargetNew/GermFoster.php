...
class GermFoster extends Command
{
     ...
     * @var string
     */
    protected $signature = 'newZb:germFoster {page?}';
    ...
    public function germFosterDataHandle($page)
    {
        ...
        while (true) {
            $data = PatientInfo::query()
                ->whereBetween('AAC01',['2022-01-01 00:00:00','2023-13-31 23:59:59'])
            ...
            foreach ($data['data'] as $val) {
                ...
                if (!$ymresultList) {
                    ...
                    PatientInfoTargetTemporary::query()->where('ZYH', '=', $ZYH)->update($saveData);
                    continue;
                }
