...
class Ryjl_cs extends Command
{
     ...
     * @var string
     */
    protected $signature = 'zb:ryjlcs {page?}';
...
//            $data = PatientInfo::query()
            ...
            foreach ($data['data'] as $value) {
                ...
                $insert = [
                    ...
                    'ryjl24_error' => '',
                    'AAC11N' => $value->AAC11N,
                    'AEE03' => !empty($patient->AEE03) ? $value->AEE03 : '',
                ...
                if ($HCRQ) {
                    ...
                    if ($CJSJ) {
                        //$numerator = 1;
                        //$ryjlError .= '，入院记录完成时间【'.$CJSJ.'（24小时内）】';
                        $surgeryGroup['status'] = 1;
                        $insert['ryjl24_fz'] += 1;
                        $surgeryGroup['content'][] = [
                            'status' => 1,
                            'content' => '入院记录完成时间【'.$CJSJ.'（24小时内）】'
                        ];
                    } else {
                        $must = [
                            ["term" => ['JZHM' => $ZYH]],
                        ...
                        if ($CJSJ) {
                            ...
                            $surgeryGroup['content'][] = [
                                'status' => 1,
                                'content' => '24小时出入院记录完成时间【'.$CJSJ.'（24小时内）】'
                            ];
                        } else {
                            $must = [
                                ["term" => ['JZHM' => $ZYH]],
                            ...
                            $CJSJ = !empty($bl01Data[0][0][$bcjlwcsj->table_field]) ? $bl01Data[0][0][$bcjlwcsj->table_field] : '';
                            if ($CJSJ) {
                                //$ryjlError .= '，入院记录【'.$CJSJ.'（超24小时）】';
                                $surgeryGroup['content'][] = [
                                    'status' => 0,
                                    'content' => '入院记录完成时间【'.$CJSJ.'（超24小时）】'
                                ];
                            } else {
                                $must = [
                                    ["term" => ['JZHM' => $ZYH]],
                                ...
                                if ($CJSJ) {
                                    ...
                                    $surgeryGroup['content'][] = [
                                        'status' => 0,
                                        'content' => '24小时出入院记录完成时间【'.$CJSJ.'（超24小时）】'
                                    ];
                                } else {
                                    //$ryjlError .= '，入院记录【无】';
                                    $surgeryGroup['content'][] = [
