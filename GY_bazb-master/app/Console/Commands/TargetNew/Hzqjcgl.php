...
class Hzqjcgl extends Command
{
     ...
     * @var string
     */
    protected $signature = 'newZb:hzqjcgl {page?}';
    ...
    protected function hzqjcglDataHandle($page)
    {
        ...
        while (true) {
            $data = PatientInfo::query()
                ->whereBetween('AAC01', ['2024-01-01 00:00:00', '2025-12-31 23:59:59'])
                    ...
                    foreach ($bcjlList as $bcjl) {
                        if ($yzbList) {
                            foreach ($yzbList as $value) {
                                ...
                                //$KZSJ_START <= $bcjl['ZXSJ'] &&
                                if ($bcjl[$bagl_11->table_field] <= $KZSJ_END) {
                                    $numerator = 1;
                                    $errorDate = '收费项目【'.$feeList[0]['FYMC'].'，'.$JFQR.'】，医嘱【'.$value['YZMC'].'，'.$value['KZSJ'].'】，病程记录【'.$bcjl['BLMC'].' '.$bcjl[$bagl_11->table_field].'，抢救成功，6小时内】';//id11
                                } else {
                                    $errorDate = '收费项目【'.$feeList[0]['FYMC'].'，'.$JFQR.'】，医嘱【'.$value['YZMC'].'，'.$value['KZSJ'].'】，病程记录【'.$bcjl['BLMC'].' '.$bcjl[$bagl_11->table_field].'，抢救成功，未在6小时内】';//id11
                                }
                            }
                        } else {
                            $errorDate = '收费项目【'.$feeList[0]['FYMC'].'，'.$JFQR.'】，医嘱【无】，病程记录【'.$bcjl['BLMC'].' '.$bcjl[$bagl_11->table_field].'】';//id11
                        }
                    }
                } else {
