...
class Zb_ssyzgfkjl extends Command
{
    protected $signature = 'zb_ssyzgfkjl {zyh?} {startTime?} {endTime?}';

    protected $description = '计算手术医嘱规范开具率指标';
    ...
    public function handle()
    {
        ...
        $this->info('开始计算手术医嘱规范开具率: ' . date("Y-m-d H:i:s"));
        ...
        $indicatorCalcService->calculateSsyzgfkjl($zyh, $startTime, $endTime);
        $e = time();
        $diff = $e - $s;
        $h = floor($diff / 3600);
