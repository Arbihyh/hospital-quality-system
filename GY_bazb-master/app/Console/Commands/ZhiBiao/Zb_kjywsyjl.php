 ...
 * @author lch 
 */
class Zb_kjywsyjl extends Command
{
     ...
     * @var string
     */
    protected $signature = 'zb_kjywsyjl {zyh?} {startTime?} {endTime?}';
     ...
     * @var string
     */
    protected $description = '指标：抗菌药物使用记录符合率';
    ...
    public function handle()
    {
        ...
        $indicatorService->handleKjywsyjl($data);
