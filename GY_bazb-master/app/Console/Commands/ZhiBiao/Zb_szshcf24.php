...
class Zb_szshcf24 extends Command
{
    protected $signature = 'zb_szshcf24 {zyh?} {startTime?} {endTime?}';

    protected $description = '计算术者术后24小时查房完成率指标';
    ...
    public function handle()
    {
        ...
        $this->info('开始计算术者术后24小时查房完成率: ' . date("Y-m-d H:i:s"));
        ...
        $indicatorCalcService->calculateSzshcf24($zyh, $startTime, $endTime);
        $e = time();
        $timeDifference = $e - $s;
