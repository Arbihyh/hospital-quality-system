 ...
 * @author lch 
 */
class Zb_scbc8wcl extends Command
{
     ...
     * @var string
     */
    protected $signature = 'zb_scbc8wcl {zyh?} {startTime?} {endTime?}';
     ...
     * @var string
     */
    protected $description = '指标：首次病程记录8小时内完成率';
    ...
    public function handle()
    {
        ...
        $indicatorService->handlescbc8wcl($data);
