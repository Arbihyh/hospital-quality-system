 ...
 * @author system
 */
class Zb_sstysqssx extends Command
{
     ...
     * @var string
     */
    protected $signature = 'zb_sstysqssx {zyh?} {startTime?} {endTime?}';
     ...
     * @var string
     */
    protected $description = '指标：手术知情同意书签署顺序规范率';
    ...
    public function handle()
    {
        ...
        $indicatorService->handleSstysqssx($data);
