 ...
 * @author lch 
 */
class Zb_zlfajcqyssh extends Command
{
     ...
     * @var string
     */
    protected $signature = 'zb_zlfajcqyssh {zyh?} {startTime?} {endTime?}';
     ...
     * @var string
     */
    protected $description = '指标：诊疗方案决策权医师审核率';
    ...
    public function handle()
    {
        ...
        $indicatorService->handleZlfajcqyssh($data);
