 ...
 * @author lch
 */
class Zb_Sjssysjsshzswl extends Command
{
     ...
     * @var string
     */
    protected $signature = 'zb_sjssysjsshzswl {zyh?} {startTime?} {endTime?}';
     ...
     * @var string
     */
    protected $description = '指标：四级手术与三级手术死亡率比';
    ...
    public function handle()
    {
        ...
        $indicatorService->handleSjssysjsshzswl($data);
