...
class Zb_szsqcf extends Command
{
    protected $signature = 'zb_szsqcf {zyh?} {startTime?} {endTime?}';

    protected $description = '计算术者术前查房完成率指标';
    ...
    public function handle()
    {
        ...
        $this->info('开始计算术者术前查房完成率: ' . date("Y-m-d H:i:s"));
        ...
        $indicatorCalcService->calculateSzsqcf($zyh, $startTime, $endTime);
        $e = time();
        $timeDifference = $e - $s;
