...
/**
 * 非计划再次手术完成（术前）疑难病历讨论率
 * @author lch
 */
class Zb_shfjhzssbltlsh extends Command
{
     ...
     * @var string
     */
    protected $signature = 'zb_shfjhzssbltlsh {zyh?} {startTime?} {endTime?}';
     ...
     * @var string
     */
    protected $description = '指标：非计划再次手术完成（术后）疑难病历讨论率';
    ...
    public function handle()
    {
        ...
        $indicatorService->handleShfjhzssbltl($data);
