 ...
 * @author lch 
 */
class Zb_kjywcfqlshg extends Command
{
     ...
     * @var string
     */
    protected $signature = 'zb_kjywcfqlshg {zyh?} {startTime?} {endTime?}';
     ...
     * @var string
     */
    protected $description = '指标：抗菌药物处方权落实合格率';
    ...
    public function handle()
    {
        ...
        $indicatorService->handleKjywcfqlshg($data);
