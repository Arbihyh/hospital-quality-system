 ...
 * 危急值报告时间指标。
 */
class Zb_wjzbgsjjz extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'zb_wjzbgsjjz {startTime?} {endTime?}';
     ...
     * @var string
     */
    protected $description = '指标：危急值报告时间(急诊)';
    ...
    public function handle()
    {
        ...
        $indicatorCalcService->calculateWjzbgsjJz($startTime, $endTime);
