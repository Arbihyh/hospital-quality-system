 ...
 * @author system
 */
class Zb_qtzdzql extends Command
{
     ...
     * @var string
     */
    protected $signature = 'zb_qtzdzql {zyh?} {startTime?} {endTime?}';
     ...
     * @var string
     */
    protected $description = '指标：其他诊断编码填写正确率';
    ...
    public function handle()
    {
        ...
        $indicatorService->handleQtzdzql4($data);
