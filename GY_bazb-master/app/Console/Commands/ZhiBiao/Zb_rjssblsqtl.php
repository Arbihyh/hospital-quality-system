 ...
 * Class Zb_rjssblsqtl
 */
class Zb_rjssblsqtl extends Command
{ /**
  * The name and signature of the console command.
  *
  * @var string
  */
    protected $signature = 'zb_rjssblsqtl {zyh?} {startTime?} {endTime?}';
     ...
     * @var string
     */
    protected $description = '指标：日间手术病历术前讨论及时完成率';
    ...
    public function handle()
    {
        ...
        $indicatorService->handleRjssblsqtl($data);
