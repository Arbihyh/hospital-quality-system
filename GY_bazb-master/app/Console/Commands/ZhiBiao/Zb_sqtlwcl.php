...
class Zb_sqtlwcl extends Command
{
    protected $signature = 'zb_sqtlwcl {zyh?} {startTime?} {endTime?}';

    protected $description = '计算术前讨论及时完成率指标';
    ...
    public function handle()
    {
        ...
        $this->info('开始计算术前讨论及时完成率: ' . date("Y-m-d H:i:s"));
        ...
        $indicatorCalcService->calculateSqtlwcl($zyh, $startTime, $endTime);
        $e = time();
        $timeDifference = $e - $s;
