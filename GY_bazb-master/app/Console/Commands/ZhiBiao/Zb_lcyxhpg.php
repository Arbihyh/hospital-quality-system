 ...
 * @author lch 
 */
class Zb_lcyxhpg extends Command
{
     ...
     * @var string
     */
    protected $signature = 'zb_lcyxhpg {zyh?} {startTime?} {endTime?}';
     ...
     * @var string
     */
    protected $description = '指标：临床用血后评估记录率';
    ...
    public function handle()
    {
        ...
        $indicatorService->handleLcyxhpg($data);
