 ...
 * @author lch
 */
class Zb_sqfjhzssbltl extends Command
{
     ...
     * @var string
     */
    protected $signature = 'zb_sqfjhzssbltl {zyh?} {startTime?} {endTime?}';
     ...
     * @var string
     */
    protected $description = '指标：非计划再次手术完成疑难病历讨论率';
    ...
    public function handle()
    {
        ...
        $indicatorService->handleNewSqfjhzssbltl($data);
