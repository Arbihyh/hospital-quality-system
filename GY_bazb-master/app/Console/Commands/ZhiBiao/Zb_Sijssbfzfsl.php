 ...
 * @author lch
 */
class Zb_Sijssbfzfsl extends Command
{
     ...
     * @var string
     */
    protected $signature = 'zb_sijssbfzfsl {zyh?} {startTime?} {endTime?}';
     ...
     * @var string
     */
    protected $description = '指标：四级手术并发症发生率';
    ...
    public function handle()
    {
        ...
        $indicatorService->handleSijssbfzfsl($data);
