 ...
 * @author lch 
 */
class Zb_xjshxxmssr extends Command
{
     ...
     * @var string
     */
    protected $signature = 'zb_xjshxxmssr {zyh?} {startTime?} {endTime?}';
     ...
     * @var string
     */
    protected $description = '指标：临床新技术和新项目（手术）实施人符合率';
    ...
    public function handle()
    {
        ...
        $indicatorService->handleXjshxxmssr($data);
