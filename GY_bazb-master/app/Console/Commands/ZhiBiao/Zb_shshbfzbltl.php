...
class Zb_shshbfzbltl extends Command
{
    protected $signature = 'zb_shshbfzbltl {zyh?} {startTime?} {endTime?}';

    protected $description = '计算手术后出现严重脏器功能损害的并发症的患者完成疑难病例讨论率指标';
    ...
    public function handle()
    {
        ...
        $this->info('开始计算手术后出现严重脏器功能损害的并发症的患者完成疑难病例讨论率: ' . date("Y-m-d H:i:s"));
        ...
        $indicatorCalcService->calculateShshbfzbltl($zyh, $startTime, $endTime);
        $e = time();
        $timeDifference = $e - $s;
