 ...
 * @author system
 */
class Zb_sstysqs extends Command
{
     ...
     * @var string
     */
    protected $signature = 'zb_sstysqs {zyh?} {startTime?} {endTime?}';
     ...
     * @var string
     */
    protected $description = '指标：手术知情同意书签署完成率';
    ...
    public function handle()
    {
        ...
        $indicatorService->handleSstysqs($data);
