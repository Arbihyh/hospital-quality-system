...
class Zb_swtljswcl extends Command
{
    protected $signature = 'zb_swtljswcl {zyh?} {startTime?} {endTime?}';

    protected $description = '计算死亡病例讨论及时完成率指标';
    ...
    public function handle()
    {
        ...
        $this->info('开始计算死亡病例讨论及时完成率: ' . date("Y-m-d H:i:s"));
        ...
        $indicatorCalcService->calculateSwtljswcl($zyh, $startTime, $endTime);
        $e = time();
        $diff = $e - $s;
        $h = floor($diff / 3600);
