 ...
 * @author lch
 */
class Zb_ejhlsjhlcy extends Command
{
     ...
     * @var string
     */
    protected $signature = 'zb_ejhlsjhlcy {zyh?} {startTime?} {endTime?}';
     ...
     * @var string
     */
    protected $description = '指标：二级护理/三级护理出院率';
    ...
    public function handle()
    {
        ...
        $indicatorService->handleEjhlsjhlcy($data, $startTime);
