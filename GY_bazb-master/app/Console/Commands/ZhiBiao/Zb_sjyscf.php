 ...
 * @author lch 
 */
class Zb_sjyscf extends Command
{
     ...
     * @var string
     */
    protected $signature = 'zb_sjyscf {zyh?} {startTime?} {endTime?}';
     ...
     * @var string
     */
    protected $description = '指标：三级医师查房频次达标率';
    ...
    public function handle()
    {
        ...
        //$indicatorService->handleSjyscf($data);
        $indicatorService->newHandleSjyscf($data);
