 ...
 * 危急值报告时间指标。
 */
class Zb_wjzbgsjmz extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'zb_wjzbgsjmz {startTime?} {endTime?}';
     ...
     * @var string
     */
    protected $description = '指标：危急值报告时间(门诊)';
    ...
    public function handle()
    {
        ...
        $indicatorCalcService->calculateWjzbgsjMz($startTime, $endTime);
