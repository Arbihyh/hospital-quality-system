 ...
 * Class Zb_rjssblsqpg
 */
class Zb_rjssblsqpg extends Command
{ /**
  * The name and signature of the console command.
  *
  * @var string
  */
    protected $signature = 'zb_rjssblsqpg {zyh?} {startTime?} {endTime?}';
     ...
     * @var string
     */
    protected $description = '指标：日间手术病历术前评估及时完成率';
    ...
    public function handle()
    {
        ...
        $indicatorService->handleRjssblsqpg($data);
