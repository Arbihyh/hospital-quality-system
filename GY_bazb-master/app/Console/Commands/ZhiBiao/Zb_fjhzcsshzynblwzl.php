 ...
 * @author system
 */
class Zb_fjhzcsshzynblwzl extends Command
{
     ...
     * @var string
     */
    protected $signature = 'zb_fjhzcsshzynblwzl {zyh?} {startTime?} {endTime?}';
     ...
     * @var string
     */
    protected $description = '指标：非计划再次手术患者疑难病例完整率';
    ...
    public function handle()
    {
        ...
        $indicatorService->handleFjhzcsshzynblwzl($data);
