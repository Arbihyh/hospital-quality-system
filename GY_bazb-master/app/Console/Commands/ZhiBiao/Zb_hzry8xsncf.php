 ...
 * @author lch
 */
class Zb_hzry8Xsncf extends Command
{
     ...
     * @var string
     */
    protected $signature = 'zb_hzry8xsncf {zyh?} {startTime?} {endTime?}';
     ...
     * @var string
     */
    protected $description = '指标：患者入院8小时内查房率';
    ...
    public function handle()
    {
        ...
        $data = $indicatorService->getPatientInfoDataAll($zyh, $startTime, $endTime);
        echo '共'.count($data) . PHP_EOL;
        $indicatorService->handleHzry8xsncf($data, $startTime);
