 ...
 * @author lch
 */
class Zb_Sjsjsssjkzl extends Command
{
     ...
     * @var string
     */
    protected $signature = 'zb_sjsjsssjkzl {zyh?} {startTime?} {endTime?}';
     ...
     * @var string
     */
    protected $description = '指标：三、四级手术实际开展率';
    ...
    public function handle()
    {
        ...
        $indicatorService->handleSjsjsssjkzl($data);
