 ...
 * @author lch 
 */
class Zb_ryjl24wcl extends Command
{
     ...
     * @var string
     */
    protected $signature = 'zb_ryjl24wcl {zyh?} {startTime?} {endTime?}';
     ...
     * @var string
     */
    protected $description = '指标：入院记录24小时完成率';
    ...
    public function handle()
    {
        ...
        $indicatorService->handleRyjl24wcl($data);
