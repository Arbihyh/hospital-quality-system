 ...
 * @author system
 */
class Zb_sstysqssj extends Command
{
     ...
     * @var string
     */
    protected $signature = 'zb_sstysqssj {zyh?} {startTime?} {endTime?}';
     ...
     * @var string
     */
    protected $description = '指标：手术知情同意书签署时间规范率';
    ...
    public function handle()
    {
        ...
        $indicatorService->handleSstysqssj($data);
