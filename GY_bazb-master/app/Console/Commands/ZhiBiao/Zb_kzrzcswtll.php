 ...
 * @author lch 
 */
class Zb_kzrzcswtll extends Command
{
     ...
     * @var string
     */
    protected $signature = 'zb_kzrzcswtll {zyh?} {startTime?} {endTime?}';
     ...
     * @var string
     */
    protected $description = '指标：科主任主持死亡讨论率';
    ...
    public function handle()
    {
        ...
        $indicatorService->handleKzrzcswtll($data);
