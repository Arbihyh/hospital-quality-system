 ...
 * 普通会诊有效率
 */
class Zb_pthzyxl extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'zb_pthzyxl {zyh?} {startTime?} {endTime?}';
     ...
     * @var string
     */
    protected $description = '计算普通会诊有效率指标';
    ...
    public function handle()
    {
        ...
        $this->info('开始计算普通会诊有效率: ' . date("Y-m-d H:i:s"));
        ...
        $indicatorCalcService->calculatePthzyxl($zyh, $startTime, $endTime);
        $e = time();
        $timeDifference = $e - $s;
