 ...
 * @author lch
 */
class Zb_sjsssqdxktl extends Command
{
     ...
     * @var string
     */
    protected $signature = 'zb_sjsssqdxktl {zyh?} {startTime?} {endTime?}';
     ...
     * @var string
     */
    protected $description = '指标：四级手术术前多学科讨论率';
    ...
    public function handle()
    {
        ...
        $this->info('开始计算四级手术术前多学科讨论率: ' . date("Y-m-d H:i:s"));
        ...
        $indicatorCalcService->calculateSjsssqdxktl($zyh, $startTime, $endTime);
        $e = time();
        $timeDifference = $e - $s;
