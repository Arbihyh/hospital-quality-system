 ...
 * @author lch
 */
class Zb_Sjssysjssbfzfsl extends Command
{
     ...
     * @var string
     */
    protected $signature = 'zb_sjssysjssbfzfsl {zyh?} {startTime?} {endTime?}';
     ...
     * @var string
     */
    protected $description = '指标：四级手术与三级手术并发症发生率比';
    ...
    public function handle()
    {
        ...
        $indicatorService->handleSjssysjssbfzfsl($data);
