...
class Zb_zbqjzlcz extends Command
{
    protected $signature = 'zb_zbqjzlcz {zyh?} {startTime?} {endTime?}';

    protected $description = '计算值班期间诊疗处置记录率指标';
    ...
    public function handle()
    {
        ...
        $this->info('开始计算值班期间诊疗处置记录率: ' . date("Y-m-d H:i:s"));
        ...
        $indicatorCalcService->calculateZbqjzlcz($zyh, $startTime, $endTime);
        $e = time();
        $timeDifference = $e - $s;
