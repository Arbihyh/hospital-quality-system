...
/**
 * 医务部门组织讨论的死亡病例与发生纠纷的死亡病例比值（医务科组织死亡病例病例讨论率）
 */
class Zb_swblyfsjfdswblbz extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'zb_swblyfsjfdswblbz {zyh?} {startTime?} {endTime?}';
     ...
     * @var string
     */
    protected $description = '计算医务部门组织讨论的死亡病例与发生纠纷的死亡病例比值（医务科组织死亡病例病例讨论率）指标';
    ...
    public function handle()
    {
        ...
        $this->info('开始计算医务部门组织讨论的死亡病例与发生纠纷的死亡病例比值（医务科组织死亡病例病例讨论率）: ' . date("Y-m-d H:i:s"));
        ...
        $indicatorCalcService->calculateSwblyfsjfdswblbz($zyh, $startTime, $endTime);
        $e = time();
        $timeDifference = $e - $s;
