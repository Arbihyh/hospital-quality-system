...
/**
 * 非计划再次手术完成（术后）疑难病历讨论率
 * @author lch 
 */
class Zb_shfjhzssbltl extends Command
{
     ...
     * @var string
     */
    protected $signature = 'zb_shfjhzssbltl {zyh?} {startTime?} {endTime?}';
     ...
     * @var string
     */
    protected $description = '指标：非计划再次入院疑难病历讨论率';
    ...
    public function handle()
    {
        ...
        $indicatorService->handleNewShfjhzssbltl($data);
