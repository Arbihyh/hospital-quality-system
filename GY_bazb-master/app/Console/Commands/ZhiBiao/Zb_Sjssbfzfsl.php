 ...
 * @author lch
 */
class Zb_Sjssbfzfsl extends Command
{
     ...
     * @var string
     */
    protected $signature = 'zb_sjssbfzfsl {zyh?} {startTime?} {endTime?}';
     ...
     * @var string
     */
    protected $description = '指标：三级手术并发症发生率';
    ...
    public function handle()
    {
        ...
        $indicatorService->handleSjssbfzfsl($data);
