...
/**
 * 日间手术病历24小时入出院记录的术前部分及时完成率
 * @author lch 
 * Class Zb_rjssblrcyjl24
 */
class Zb_rjssblrcyjl24 extends Command
{ /**
  * The name and signature of the console command.
  *
  * @var string
  */
    protected $signature = 'zb_rjssblrcyjl24 {zyh?} {startTime?} {endTime?}';
     ...
     * @var string
     */
    protected $description = '指标：日间手术病历24小时入出院记录的术前部分及时完成率';
    ...
    public function handle()
    {
        ...
        $indicatorService->handleRjssblrcyjl24($data);
