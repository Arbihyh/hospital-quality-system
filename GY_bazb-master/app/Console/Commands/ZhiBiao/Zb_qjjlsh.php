...
class Zb_qjjlsh extends Command
{
    protected $signature = 'zb_qjjlsh {zyh?} {startTime?} {endTime?}';

    protected $description = '计算抢救记录审核率指标';
    ...
    public function handle()
    {
        ...
        $this->info('开始计算抢救记录审核率: ' . date("Y-m-d H:i:s"));
        ...
        $indicatorCalcService->calculateQjjlsh($zyh, $startTime, $endTime);
        $e = time();
        $timeDifference = $e - $s;
