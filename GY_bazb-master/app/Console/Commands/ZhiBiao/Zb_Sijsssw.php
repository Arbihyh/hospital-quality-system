 ...
 * @author lch
 */
class Zb_Sijsssw extends Command
{
     ...
     * @var string
     */
    protected $signature = 'zb_sijsssw {zyh?} {startTime?} {endTime?}';
     ...
     * @var string
     */
    protected $description = '指标：四级手术死亡';
    ...
    public function handle()
    {
        ...
        $indicatorService->handleSijsssw($data);
