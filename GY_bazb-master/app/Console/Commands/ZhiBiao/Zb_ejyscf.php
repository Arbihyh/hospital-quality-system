 ...
 * @author lch 
 */
class Zb_ejyscf extends Command
{
     ...
     * @var string
     */
    protected $signature = 'zb_ejyscf {zyh?} {startTime?} {endTime?}';
     ...
     * @var string
     */
    protected $description = '指标：二级医师查房频次达标率';
    ...
    public function handle()
    {
        ...
        $indicatorService->handleEjyscf($data);
