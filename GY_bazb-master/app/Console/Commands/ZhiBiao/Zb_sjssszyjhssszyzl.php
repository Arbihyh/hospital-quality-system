 ...
 * 实际手术术者与计划手术术者一致率
 */
class Zb_sjssszyjhssszyzl extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'zb_sjssszyjhssszyzl {zyh?} {startTime?} {endTime?}';
     ...
     * @var string
     */
    protected $description = '计算实际手术术者与计划手术术者一致率指标';
    ...
    public function handle()
    {
        ...
        $this->info('开始计算实际手术术者与计划手术术者一致率: ' . date("Y-m-d H:i:s"));
        ...
        $indicatorCalcService->calculateSjssszyjhssszyzl($zyh, $startTime, $endTime);
        $e = time();
        $timeDifference = $e - $s;
