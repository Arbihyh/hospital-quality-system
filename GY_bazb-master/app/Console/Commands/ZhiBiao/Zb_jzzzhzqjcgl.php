...
class Zb_jzzzhzqjcgl extends Command
{
    protected $signature = 'zb_jzzzhzqjcgl {zyh?} {startTime?} {endTime?}';

    protected $description = '急症重症患者抢救完成率';
    ...
    public function handle()
    {
        ...
        $indicatorCalcService->calculateJzzzhzqjcgl($zyh, $startTime, $endTime);
        $e = time();
        $timeDifference = $e - $s;
