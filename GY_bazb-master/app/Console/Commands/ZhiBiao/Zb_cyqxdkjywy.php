 ...
 * @author lch 
 */
class Zb_cyqxdkjywy extends Command
{
     ...
     * @var string
     */
    protected $signature = 'zb_cyqxdkjywy {zyh?} {startTime?} {endTime?}';
     ...
     * @var string
     */
    protected $description = '指标：超越权限的抗菌药物药物处方时限合格率';
    ...
    public function handle()
    {
        ...
        $indicatorService->handleCyqxdkjywy($data);
