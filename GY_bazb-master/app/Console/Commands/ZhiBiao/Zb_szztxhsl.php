 ...
 * 术中自体血回输率
 */
class Zb_szztxhsl extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'zb_szztxhsl {zyh?} {startTime?} {endTime?}';
     ...
     * @var string
     */
    protected $description = '计算术中自体血回输率指标';
    ...
    public function handle()
    {
        ...
        $this->info('开始计算术中自体血回输率: ' . date("Y-m-d H:i:s"));
        ...
        $indicatorCalcService->calculateSzztxhsl($zyh, $startTime, $endTime);
        $e = time();
        $timeDifference = $e - $s;
