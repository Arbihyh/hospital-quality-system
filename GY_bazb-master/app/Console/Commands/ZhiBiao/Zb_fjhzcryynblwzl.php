 ...
 * @author system
 */
class Zb_fjhzcryynblwzl extends Command
{
     ...
     * @var string
     */
    protected $signature = 'zb_fjhzcryynblwzl {zyh?} {startTime?} {endTime?}';
     ...
     * @var string
     */
    protected $description = '指标：非计划再次入院疑难病例完整率';
    ...
    public function handle()
    {
        ...
        $indicatorService->handleFjhzcryynblwzl($data);
