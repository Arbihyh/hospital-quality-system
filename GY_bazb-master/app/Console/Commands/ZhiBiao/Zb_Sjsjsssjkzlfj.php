 ...
 * @author lch
 */
class Zb_Sjsjsssjkzlfj extends Command
{
     ...
     * @var string
     */
    protected $signature = 'zb_sjsjsssjkzlfj {zyh?} {startTime?} {endTime?}';
     ...
     * @var string
     */
    protected $description = '附加指标：50.1.三、四级手术实际开展率';
    ...
    public function handle()
    {
        ...
        $indicatorService->handleSjsjsssjkzlfj($data);
