 ...
 * 急会诊有效率
 */
class Zb_jhzyxl extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'zb_jhzyxl {zyh?} {startTime?} {endTime?}';
     ...
     * @var string
     */
    protected $description = '计算急会诊有效率指标';
    ...
    public function handle()
    {
        ...
        $this->info('开始计算急会诊有效率: ' . date("Y-m-d H:i:s"));
        ...
        $indicatorCalcService->calculateJhzyxl($zyh, $startTime, $endTime);
        $e = time();
        $timeDifference = $e - $s;
