 ...
 * @author lch 
 */
class Zb_lcyxqpg extends Command
{
     ...
     * @var string
     */
    protected $signature = 'zb_lcyxqpg {zyh?} {startTime?} {endTime?}';
     ...
     * @var string
     */
    protected $description = '指标：临床用血前评估记录率';
    ...
    public function handle()
    {
        ...
        $indicatorService->handleLcyxqpg($data);
