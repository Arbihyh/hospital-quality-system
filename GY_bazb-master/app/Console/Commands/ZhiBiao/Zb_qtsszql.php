 ...
 * @author system
 */
class Zb_qtsszql extends Command
{
     ...
     * @var string
     */
    protected $signature = 'zb_qtsszql {zyh?} {startTime?} {endTime?}';
     ...
     * @var string
     */
    protected $description = '指标：其他手术编码填写正确率';
    ...
    public function handle()
    {
        ...
        $indicatorService->handleQtsszql($data);
