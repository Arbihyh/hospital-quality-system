 ...
 * @author lch
 */
class Zb_mzysmzsjch extends Command
{
     ...
     * @var string
     */
    protected $signature = 'zb_sjch {zyh?} {startTime?} {endTime?}';
     ...
     * @var string
     */
    protected $description = '指标：麻醉医师麻醉时间重合率';
    ...
    public function handle()
    {
        ...
        $indicatorService->handleMzysmzsjch($zyh, $startTime, $endTime);
