 ...
 * @author lch
 */
class Zb_cqyzdrzz extends Command
{
     ...
     * @var string
     */
    protected $signature = 'zb_cqyzdrzz {zyh?} {startTime?} {endTime?}';
     ...
     * @var string
     */
    protected $description = '指标：长期医嘱当日终止率';
    ...
    public function handle()
    {
        ...
        $indicatorService->handleCqyzdrzz($data);
