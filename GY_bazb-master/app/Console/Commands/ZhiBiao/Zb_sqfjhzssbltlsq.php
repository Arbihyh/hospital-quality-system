 ...
 * @author lch
 */
class Zb_sqfjhzssbltlsq extends Command
{
     ...
     * @var string
     */
    protected $signature = 'zb_sqfjhzssbltlsq {zyh?} {startTime?} {endTime?}';
     ...
     * @var string
     */
    protected $description = '指标：非计划再次手术完成（术前）疑难病历讨论率';
    ...
    public function handle()
    {
        ...
        $indicatorService->handleSqfjhzssbltl($data);
