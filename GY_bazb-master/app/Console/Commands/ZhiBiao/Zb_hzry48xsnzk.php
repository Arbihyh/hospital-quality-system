 ...
 * @author lch
 */
class Zb_hzry48xsnzk extends Command
{
     ...
     * @var string
     */
    protected $signature = 'zb_hzry48xsnzk {zyh?} {startTime?} {endTime?}';
     ...
     * @var string
     */
    protected $description = '指标：患者入院48小时内转科率';
    ...
    public function handle()
    {
        ...
        $indicatorService->handleHzry48xsnzk($data, $startTime);
