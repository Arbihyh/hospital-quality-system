 ...
 * @author lch 
 */
class Zb_ssjlwc24 extends Command
{
     ...
     * @var string
     */
    protected $signature = 'zb_ssjlwc24 {zyh?} {startTime?} {endTime?}';
     ...
     * @var string
     */
    protected $description = '指标：手术记录24小时完成率';
    ...
    public function handle()
    {
        ...
        $indicatorService->handleSsjlwc24($data);
