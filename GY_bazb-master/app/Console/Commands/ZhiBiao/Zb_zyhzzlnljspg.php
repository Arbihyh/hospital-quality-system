 ...
 * @author system
 */
class Zb_zyhzzlnljspg extends Command
{
     ...
     * @var string
     */
    protected $signature = 'zb_zyhzzlnljspg {zyh?} {startTime?} {endTime?}';
     ...
     * @var string
     */
    protected $description = '指标：院患者自理能力及时评估率';
    ...
    public function handle()
    {
        ...
        $indicatorService->handleZyhzzlnljspg($data);
