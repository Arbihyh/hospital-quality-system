...
class Ircr extends Command
{
     ...
     * @var string
     */
    protected $signature = 'zb:ircr {page?}';
...
//                $query->where('JCMC','like',"%ct%")->orWhere('JCMC','like',"%mr%")->orWhere('JCMC','like',"%磁共振%");
//            })
//            ->get()->toArray();
...
//            ['match_phrase' => ["JCMC" => "CT"]],
//            ['match_phrase' => ["JCMC" => "磁共振"]],
...
//            ['match_phrase' => ["JCMC" => "MRI"]]
        ...
        return $list;
//        return array_merge($list,$pacsList);
    }
