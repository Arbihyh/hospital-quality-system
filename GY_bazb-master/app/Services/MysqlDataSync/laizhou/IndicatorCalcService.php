...
use App\Services\MysqlDataSync\laizhou\IndicatorService;
...
class IndicatorCalcService
{
    ...
    public function calculateAll($zyh = "", $start_time = "", $end_time = "")
    {
        ...
        // 计算普通会诊有效率
        $this->calculatePyhzyxl($zyh, $start_time, $end_time);
        // 计算手术患者特级护理/一级护理出院率
    ...
    public function calculateQjcg($zyh = "", $start_time = "", $end_time = "")
    {
        ...
        $ruleMap8026 = RuleWordMap::query()->where("id", "=", 8026)->first()->toArray();
        $bigRescueKeyword = $ruleMap8026['keyword'] ?? '大抢救';
    ...
    public function calculateSwtljswcl($zyh = "", $start_time = "", $end_time = "")
    {
        ...
        foreach ($patientData as $patient) {
            ...
            var_dump("死亡时间：" . $swsj . ($isFromNotice ? "（来自死亡通知书）" : "（来自AAC01）"));
