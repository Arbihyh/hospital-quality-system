    ...
    public function exzlfl($zyh, $start, $end)
    {
        ...
        while (true) {
            ...
            foreach ($data->items() as $value) {
                ...
                $esService->esSaveIndicator($ZYH, ['exzlfl_fz' => 0, 'exzlfl_fm' => 0, 'exzlfl_error' => null]);
    ...
    public function ryjl24($zyh, $start, $end)
    {
        ...
        while (true) {
            ...
            foreach ($data->items() as $value) {
                ...
                $esService->esSaveIndicator($ZYH, ['ryjl24_fm' => null, 'ryjl24_fz' => null, 'ryjl24_error' => null]);
    ...
    public function cyjl24($zyh, $start, $end)
    {
        ...
        while (true) {
            ...
            foreach ($data->items() as $value) {
                ...
                $esService->esSaveIndicator($ZYH, ['cyjl24_fm' => null, 'cyjl24_fz' => null, 'cyjl24_error' => null]);
    ...
    public function basy24($zyh, $start, $end)
    {
        ...
        while (true) {
            ...
            foreach ($data->items() as $value) {
                ...
                $esService->esSaveIndicator($ZYH, ['basy24_fm' => null, 'basy24_fz' => null, 'basy24_error' => null]);
                ...
                if (!empty($CYSJ)) {
                    ...
                    if (!empty($blsy)) {
                        $firstSignTime = $blsy[0]['SYSJ'];
                        if (strtotime($firstSignTime) < strtotime($endTime)) {
                            $insert['basy24_fz'] = 1;
                            $surgeryGroup['status'] = 1;
                            $surgeryGroup['content'][] = [
                                'status' => 1,
                                'content' => '病案首页完成时间【' . $blsy[0]['SYSJ'] . '】'
                            ];
                        } else {
                            $surgeryGroup['content'][] = [
                                'status' => 0,
    ...
    public function ssjl24($zyh, $start, $end)
    {
        ...
        while (true) {
            ...
            foreach ($data->items() as $value) {
                ...
                $esService->esSaveIndicator($ZYH, ['ssjl24_fm' => null, 'ssjl24_fz' => null, 'ssjl24_error' => null]);
    ...
    public function ctmrfhl($zyh, $start, $end)
    {
        ...
        while (true) {
            ...
            foreach ($data->items() as $value) {
                ...
                $esService->esSaveIndicator($ZYH, ['ctmrfhl_fm' => null, 'ctmrfhl_fz' => null, 'ctmrfhl_error' => null]);
    ...
    public function bljcjl($zyh, $start, $end)
    {
        ...
        while (true) {
            ...
            foreach ($data->items() as $value) {
                ...
                $esService->esSaveIndicator($ZYH, ['bljcjl_fm' => null, 'bljcjl_fz' => null, 'bljcjl_error' => null]);
    ...
    public function kjywsy($zyh, $start, $end)
    {
        ...
        while (true) {
            ...
            foreach ($data->items() as $value) {
                ...
                $esService->esSaveIndicator($ZYH, ['kjywsy_fm' => null, 'kjywsy_fz' => null, 'kjywsy_error' => null]);
    ...
    public function exzlhxzl($zyh, $start, $end)
    {
        ...
        while (true) {
            ...
            foreach ($data->items() as $value) {
                ...
                $esService->esSaveIndicator($ZYH, ['exzlhxzl_fm' => null, 'exzlhxzl_fz' => null, 'exzlhxzl_error' => null]);
                if ($this->skipAAA28($value->AAA28)) {
                    continue;
                }
    ...
    public function jjbll($zyh, $start, $end)
    {
        ...
        while (true) {
            ...
            foreach ($data->items() as $value) {
                ...
                $esService->esSaveIndicator($ZYH, ['jjbll_fm' => null, 'jjbll_fz' => null, 'jjbll_error' => null]);
                if ($this->skipAAA28($value->AAA28)) {
                    continue;
                }
    ...
    public function ssxgjl($zyh, $start, $end)
    {
        ...
        while (true) {
            ...
            foreach ($data->items() as $value) {
                ...
                $esService->esSaveIndicator($ZYH, ['ssxgjl_fm' => null, 'ssxgjl_fz' => null, 'ssxgjl_error' => null]);
                if ($this->skipAAA28($value->AAA28)) {
                    continue;
                }
    ...
    public function hzqjcgl($zyh, $start, $end)
    {
        ...
        while (true) {
            ...
            foreach ($data->items() as $value) {
                ...
                $esService->esSaveIndicator($ZYH, ['hzqjcgl_fm' => null, 'hzqjcgl_fz' => null, 'hzqjcgl_error' => null]);
    ...
    public function hzqjjsl($zyh, $start, $end)
    {
        ...
        while (true) {
            ...
            foreach ($data->items() as $value) {
                ...
                $esService->esSaveIndicator($ZYH, ['hzqjjsl_fm' => null, 'hzqjjsl_fz' => null, 'hzqjjsl_error' => null]);
    ...
    public function bhlfzbl($zyh, $start, $end)
    {
        ...
        while (true) {
            ...
            foreach ($data->items() as $value) {
                ...
                $esService->esSaveIndicator($ZYH, ['bhlfzbl_fm' => null, 'bhlfzbl_fz' => null, 'bhlfzbl_error' => null]);
    ...
    public function yscf($zyh, $start, $end)
    {
        ...
        while (true) {
            ...
            foreach ($data->items() as $value) {
                ...
                $esService->esSaveIndicator($ZYH, ['yscf_fm' => null, 'yscf_fz' => null, 'yscf_error' => null]);
    ...
    public function lcyx($zyh, $start, $end)
    {
        ...
        while (true) {
            ...
            foreach ($data->items() as $value) {
                ...
                $esService->esSaveIndicator($ZYH, ['lcyx_fm' => null, 'lcyx_fz' => null, 'lcyx_error' => null]);
                ...
                if (!empty($yzbData[0])) {
                    foreach ($yzbData[0] as $yz) {
                        ...
                        $params = $bl01Service->clearMust()->queryByMustBatch($must)->paginate(1, 1000)->getParams();
                        $restful = app('es')->search($params);
                        $surgeryData = $bl01Service->getDataByEs($restful);
    ...
    public function xjpyjcjl($zyh, $start, $end)
    {
        ...
        while (true) {
            ...
            foreach ($data->items() as $value) {
                ...
                $esService->esSaveIndicator($ZYH, ['xjpyjcjl_fm' => null, 'xjpyjcjl_fz' => null, 'xjpyjcjl_error' => null]);
    ...
    public function zrw($zyh, $start, $end)
    {
        ...
        while (true) {
            ...
            foreach ($data->items() as $value) {
                ...
                $esService->esSaveIndicator($ZYH, ['zrw_fm' => null, 'zrw_fz' => null, 'zrw_error' => null]);
    ...
    public function cdl($zyh, $start, $end)
    {
        ...
        while (true) {
            ...
            foreach ($data->items() as $value) {
                ...
                $esService->esSaveIndicator($ZYH, ['cdl_fm' => null, 'cdl_fz' => null, 'cdl_error' => null]);
    ...
    public function gdwzl($zyh, $start, $end)
    {
        ...
        while (true) {
            ...
            foreach ($data->items() as $value) {
                ...
                $esService->esSaveIndicator($ZYH, ['gdwzl_fm' => null, 'gdwzl_fz' => null, 'gdwzl_error' => null]);
    ...
    public function zyzdbmzql($zyh, $start, $end)
    {
        ...
        while (true) {
            ...
            foreach ($data->items() as $value) {
                ...
                $esService->esSaveIndicator($ZYH, ['zyzdbmzql_fm' => null, 'zyzdbmzql_fz' => null, 'zyzdbmzql_error' => null]);
    ...
    public function zyzdzql($zyh, $start, $end)
    {
        ...
        while (true) {
            ...
            foreach ($data->items() as $value) {
                ...
                $esService->esSaveIndicator($ZYH, ['zyzdzql_fm' => null, 'zyzdzql_fz' => null, 'zyzdzql_error' => null]);
    ...
    public function zyssbmzql($zyh, $start, $end)
    {
        ...
        while (true) {
            ...
            foreach ($data->items() as $value) {
                ...
                $esService->esSaveIndicator($ZYH, ['zyssbmzql_fm' => null, 'zyssbmzql_fz' => null, 'zyssbmzql_error' => null]);
    ...
    public function zysszql($zyh, $start, $end)
    {
        ...
        while (true) {
            ...
            foreach ($data->items() as $value) {
                ...
                $esService->esSaveIndicator($ZYH, ['zysszql_fm' => null, 'zysszql_fz' => null, 'zysszql_error' => null]);
    ...
    public function zqtys($zyh, $start, $end)
    {
        ...
        while (true) {
            ...
            foreach ($data->items() as $value) {
                ...
                $esService->esSaveIndicator($ZYH, ['zqtys_fm' => null, 'zqtys_fz' => null, 'zqtys_error' => null]);
