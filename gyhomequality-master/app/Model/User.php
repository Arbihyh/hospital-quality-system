...
class User extends Model
{
    ...
    protected static $field = ["id", "name", "password", "group_id", "phone", "realname", "status", "login_at", "login_ip", "created_at", "updated_at","dep_id","desc"];
    ...
    // 添加
    public static function add($name, $pwd, $groupId, $phone = '', $realname = '', $depId='', $desc='')
    {
        return self::query()->insert(["name" => $name, "password" => md5($pwd), 'group_id' => $groupId, 'phone' => $phone, 'realname' => $realname, 'dep_id'=>$depId, 'desc' => $desc]);
    }
