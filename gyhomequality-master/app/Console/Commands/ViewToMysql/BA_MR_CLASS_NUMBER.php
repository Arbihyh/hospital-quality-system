...
class BA_MR_CLASS_NUMBER extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'laravel:ba_mr_class_number {start} {end}';
    ...
    public function handle()
    {
        ...
        while (true) {
            ...
            $sql = "SELECT patient_id,visit_id,MrClass,Quantity,serial_no FROM BA_MR_CLASS_NUMBER";
            ...
            foreach ($data as $item) {
                ...
                \App\Model\BA_MR_CLASS_NUMBER::query()->updateOrInsert(['ZYH' => $insertData['ZYH']], $insertData);
            }
