...
class BA_RECEIVE extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'laravel:ba_receive {start} {end}';
     ...
     * @var string
     */
    protected $description = '同步 无纸化归档时间';
    ...
    public function handle()
    {
        ...
        while (true) {
            ...
            $sql = "SELECT bah,zycs,brxm,brsfzh,cysj,cyksname,MaxCheckTime,mr_archive_time FROM BA_RECEIVE";
            ...
            foreach ($data as $item) {
                ...
                \App\Model\BA_RECEIVE::query()->updateOrInsert(['ZYH' => $insertData['ZYH']], $insertData);
            }
