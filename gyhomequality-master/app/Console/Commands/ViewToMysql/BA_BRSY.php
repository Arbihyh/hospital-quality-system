...
class BA_BRSY extends Command
{
    ...
    public function handle()
    {
        ...
        while (true) {
            ...
            $sql = "SELECT ZYH AS AAA28,CYBQ,ZZYLJG FROM PORTAL_HIS.ba_brsy WHERE CYRQ BETWEEN TO_DATE('".$star."000000', 'yyyy-MM-dd HH24:mi:ss') AND TO_DATE('".$star."235959', 'yyyy-MM-dd HH24:mi:ss')";
