...
class OperationClean extends Command
{
    /**
     ...
     */
    protected $signature = 'command:operationClean';
     ...
     * @var string
     */
    protected $description = 'Command 清洗医嘱本名称中是否包含手术信息';
