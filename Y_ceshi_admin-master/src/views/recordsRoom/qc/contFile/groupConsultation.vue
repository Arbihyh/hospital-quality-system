      ...
      <div class="table">
        <table ref="tables">
          ...
          <tr>
            ...
            <td class="table-value m-all" colspan="3" />
            <td class="table-value m-all" colspan="1">会议类型:</td>
            <td class="table-value m-all" colspan="3" />
            <td class="table-value m-all" colspan="1" />
          </tr>
          <tr>
            <td class="table-value m-all" style="height: 120px" colspan="1" />
            <td class="table-value m-all" style="height: 120px" colspan="1">患者病情及诊疗情况:</td>
            <td class="table-value m-all" style="height: 120px" colspan="7" />
            <td class="table-value m-all" style="height: 120px" colspan="1" />
          </tr>
          <tr>
            <td class="table-value m-all" style="height: 120px" colspan="1" />
          ...
          <tr>
            <td class="table-value m-all" colspan="5" />
