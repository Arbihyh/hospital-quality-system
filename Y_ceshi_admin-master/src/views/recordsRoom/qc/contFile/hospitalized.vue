      ...
      <div class="table">
        <table ref="tables">
          ...
          <tr>
            ...
            <td class="table-value" style="height: 80px" colspan="8" />
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="table-value m-left" style="height: 120px" colspan="7" />
          </tr>
          <tr>
            <td class="table-label" colspan="10">体格检查</td>
          </tr>
          <tr>
            <td class="table-value" style="height: 200px" colspan="10" />
          </tr>
          <tr>
