  ...
  <div id="MyDiv">
    <div class="cont-left">
      ...
      <div class="table">
        <table ref="tables">
          <tr>
            <td class="table-value m-all" colspan="1" />
            <td class="table-value m-all" colspan="1" />
            <td class="table-value m-all" colspan="1" />
            <td class="table-value m-all" colspan="1" />
            <td class="table-value m-all" colspan="1" />
          ...
          <tr>
            ...
            <td class="table-value" colspan="9" />
          </tr>
          <tr>
          ...
          <tr style="border-left: 1px solid #dddddd; border-right: 1px solid #dddddd">
            ...
            <td class="table-value m-all" colspan="6" />
          </tr>
          <tr style="border-left: 1px solid #dddddd; border-right: 1px solid #dddddd">
          ...
          <tr style="border-left: 1px solid #dddddd; border-right: 1px solid #dddddd">
            ...
            <td class="table-value m-all" style="text-align: left" colspan="5" />
          </tr>
          <tr style="border-left: 1px solid #dddddd; border-right: 1px solid #dddddd">
            <td class="table-value m-all" colspan="2">送检标本名称:</td>
            <td class="table-value m-all" colspan="8" />
          </tr>
          <tr style="border-left: 1px solid #dddddd; border-right: 1px solid #dddddd">
            <td class="table-value m-all" colspan="2">送检标本名称:</td>
            <td class="table-value m-all" colspan="8" />
          ...
          <tr style="border-left: 1px solid #dddddd; border-right: 1px solid #dddddd">
            ...
            <td class="table-value m-all" colspan="1">是</td>
            <td class="table-value m-all" colspan="2" />
            <td class="table-value m-all" colspan="1">输血:</td>
            <td class="table-value m-all" colspan="4" />
          </tr>
          <tr style="border-left: 1px solid #dddddd; border-right: 1px solid #dddddd">
