  ...
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="13">
        ...
        <el-col :span="1.5">
          <el-button
            v-if="checkPermission(['admin/admin/addAdminGroup'])"
            type="primary"
            plain
            icon="el-icon-plus"
            size="small"
        ...
        <template slot-scope="scope">
          <div>
            ...
            >
              <div>
                <el-button
                  v-if="checkPermission(['admin/admin/editAdminGroup'])"
                  type="primary"
                  icon="el-icon-edit"
                  size="mini"
                  circle
                ...
                />
                <el-button
                  v-if="scope.row.status === 1 && checkPermission(['admin/admin/delAdminGroup'])"
                  type="danger"
                  icon="el-icon-delete"
                  circle
                  size="mini"
