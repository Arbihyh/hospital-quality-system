...
export default {
  ...
  methods: {
    ...
    toPage(row, status) {
      ...
      this.$router.push({ path: '/majorIndexDetail', query: { startTime,endTime,year: row.year, month,AAC11N:this.formInline.AAC11N,AEE03:this.formInline.AEE03, status,catalog:this.indexData.url}})
    },
    alertText() {
