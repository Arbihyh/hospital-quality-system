      ...
      <el-row :gutter="20">
        <el-col :span="9">
          <el-form-item label="出院时间">
            <div class="selects">
              <el-date-picker v-model="data.start_time" type="date" format="yyyy 年 MM 月 dd 日" value-format="yyyyMMdd" placeholder="开始日期"></el-date-picker>
              <el-date-picker
        ...
        <el-col :span="5">
          <el-form-item label="医师姓名">
            <el-select v-model="data.code" filterable clearable placeholder="全部" style="width: 100%">
        ...
        <el-col :span="5">
          <el-form-item label="病案号" prop="AAA28">
            <el-input style="width: 94%" placeholder="请输入病案编号" v-model="data.AAA28" clearable></el-input>
          </el-form-item>
        </el-col>
...
export default {
  ...
  created() {
    if (this.data.code) {
      this.$set(this.data, 'code', this.data.code);
    }
    this.getDoctors();
    this.getDepartment();
  },
