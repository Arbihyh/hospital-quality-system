...
export function get_template_departments(data) {
  return request({
    url: '/admin/big_model/get_custom_template_departments',
    method: 'get',
    params: data
  })
} 

export function get_template_diseases(data) {
  return request({
    url: '/admin/big_model/get_custom_template_diseases',
    method: 'get',
    params: data
  })
}
