    ...
    public function department(Request $request)
    {
        ...
        if ($result->isEmpty()) {
            ...
            $outstanding = PatientHospitalInfo::query()
                ...
                ->toArray();
            foreach ($res as &$v) {
                $v['name'] = $names[$v['department_id']]['name'];
                $v['outstanding'] = isset($outstanding[$names[$v['department_id']]['code']]) ? sprintf('%.2f', $outstanding[$names[$v['department_id']]['code']]['count'] / $v['total_medical']) : 0;
            }
