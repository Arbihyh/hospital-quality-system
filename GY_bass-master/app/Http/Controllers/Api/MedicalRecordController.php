...
class MedicalRecordController extends Controller
{
    ...
    public function home(Request $request)
    {
		 ...
		 */
        $data = ToolsService::codeTransformationInfo(['AAB01', 'AAA23C','ABF02C','AEB02C','AEI01C','AAA26C','AAA02C','AAA06C','AAA08C','AAA18C','AAB06C','AEM01C','AEM03C','AEG01C','AEG02C','AAA05C','AAB02C','AAC02C'],$data);
